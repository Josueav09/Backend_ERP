...
exports.getVerificationCodeEmailHTML = getVerificationCodeEmailHTML;
exports.getVerificationCodeEmailText = getVerificationCodeEmailText;
function getVerificationCodeEmailHTML(code) {
    return `
<!DOCTYPE html>
<html lang="es">
<head>
...
function getVerificationCodeEmailText(code) {
    return `
...
//# sourceMappingURL=verification-email.templates.js.map