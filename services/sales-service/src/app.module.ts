...
// // ✅ IMPORTAR TODAS LAS ENTIDADES COMPARTIDAS
...
//       inject: [ConfigService],
//       useFactory: (configService: ConfigService) => {
//         console.log('=== SALES SERVICE - DATABASE CONFIG ===');
//         console.log('DB_HOST:', configService.get('DB_HOST'));
//         console.log('DB_DATABASE:', configService.get('DB_DATABASE'));
//         console.log('========================================');
...
//           password: configService.get('DB_PASSWORD') || 'josue12345',
//           database: configService.get('DB_DATABASE') || 'growviabd',
