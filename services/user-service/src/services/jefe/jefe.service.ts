...
export class JefeService {
  ...
  */
  ...
  //     const [statsData, dashboardData, pipelineData] = await Promise.all([
  //       // Nueva vista de dashboard stats
  //       this.trazabilidadRepository.query('SELECT * FROM vista_dashboard_stats LIMIT 1'),

  //       // Vista existente de dashboard ejecutivas
  //       this.trazabilidadRepository.query('SELECT * FROM vista_dashboard_ejecutiva'),

  //       // Vista existente de pipeline
  //       this.trazabilidadRepository.query('SELECT * FROM vista_pipeline_ventas')
  //     ]);
  ...
  //       },
  //       pipeline: pipelineData // ✅ AGREGAR datos del pipeline para los gráficos
  //     };

  //     console.log('✅ [JefeService] Estadísticas finales desde vistas:', {
  //       totalEmpresas: stats.totalEmpresas,
  //       totalEjecutivas: stats.totalEjecutivas,
  //       totalClientes: stats.totalClientes,
  //       revenueTotal: stats.revenueTotal,
  //       actividadesMes: stats.kpis.actividadesMes
  //     });
  ...
  // ✅ Método de respaldo si fallan las vistas
